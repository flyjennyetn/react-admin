...
import { Card,Icon,Tooltip,Modal,Form, Row, Col, Tree ,TreeSelect ,Input,Select ,InputNumber,Button } from 'antd';
...
export default class extends PureComponent {
    ...
    handleGetIcon= (iconsName)=>{
        ...
        this.setState({
            iconVisible:false,
            menuData:_.assign(menuData,{icon:iconsName,iconsName})
        })
    }
    //目录类型切换
    handleType = (type)=>{
        ...
        return (
            <div className="gutter-example">
                                        ...
                                        >
                                            {getFieldDecorator('iconsName', {
                                                ...
                                                <Input 
                                                    ...
                                                    prefix={<Icon type={menuData.icon} style={{fontSize: 15}} />} 
                ...
                <Icons
                    ...
                    onClick={(iconsName)=>this.handleGetIcon(iconsName)}
                    footer={null}
                    title="图标"
                />
